...
class FTSDataPrepareMapper extends Mapper[LW, T, T, LW] with CommonMR {
  ...
  //This method is used for changing the universe of discourse in every generation for the FTS.
